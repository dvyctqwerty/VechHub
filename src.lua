...
local RayfieldFolder = "VechHub"
local ConfigurationFolder = RayfieldFolder.."/Configurations"
local ConfigurationExtension = ".Vchb"
...
local RayfieldLibrary = {
	...
	Theme = {
		Default = {
			...
			Background = Color3.fromRGB(18, 0, 25),
			Topbar = Color3.fromRGB(29, 0, 34),
			Shadow = Color3.fromRGB(14, 0, 20),

			NotificationBackground = Color3.fromRGB(11, 0, 20),
			NotificationActionsBackground = Color3.fromRGB(107, 0, 230),

			TabBackground = Color3.fromRGB(43, 0, 80),
			TabStroke = Color3.fromRGB(54, 0, 85),
			TabBackgroundSelected = Color3.fromRGB(129, 0, 210),
			TabTextColor = Color3.fromRGB(160, 0, 240),
			SelectedTabTextColor = Color3.fromRGB(23, 0, 50),

			ElementBackground = Color3.fromRGB(22, 0, 35),
			ElementBackgroundHover = Color3.fromRGB(21, 0, 40),
			SecondaryElementBackground = Color3.fromRGB(11, 0, 25), -- For labels and paragraphs
			ElementStroke = Color3.fromRGB(25, 0, 50),
			SecondaryElementStroke = Color3.fromRGB(25, 0, 40), -- For labels and paragraphs

			SliderBackground = Color3.fromRGB(136, 0, 255),
			SliderProgress = Color3.fromRGB(85, 0, 159),
			SliderStroke = Color3.fromRGB(118, 0, 177),

			ToggleBackground = Color3.fromRGB(22, 0, 30),
			ToggleEnabled = Color3.fromRGB(78, 0, 214),
			ToggleDisabled = Color3.fromRGB(100, 0, 0),
			ToggleEnabledStroke = Color3.fromRGB(119, 0, 255),
			ToggleDisabledStroke = Color3.fromRGB(125, 0, 0),
			ToggleEnabledOuterStroke = Color3.fromRGB(63, 0, 100),
			ToggleDisabledOuterStroke = Color3.fromRGB(65, 0, 0),

			InputBackground = Color3.fromRGB(22, 0, 30),
			InputStroke = Color3.fromRGB(57, 0, 65),
			PlaceholderColor = Color3.fromRGB(83, 0, 178)
		},
		Light = {
